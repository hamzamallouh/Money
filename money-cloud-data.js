window.MONEY_CLOUD_BACKUP={
version:1,savedAt:'2026-09-07',currency:'JOD',
salary:{base:850,actual:{'2026-09':940}},
fixed:[{id:'screenshot-fixed-group-2026-09',name:'الجمعية',amount:600,category:'الجمعية'}],
transactions:[
...
{id:'screenshot-fixed-group-2026-09',type:'expense',amount:600,name:'جمعية',category:'الجمعية',date:'2026-09-07T16:00:00+03:00',icon:'👥',auto:'fixed-screenshot-fixed-group-2026-09',month:'2026-09'}],
debts:[]};
(function(){const K='money_v3',M='money_cloud_initialized_v1';if(localStorage.getItem(M)==='1')return;let d;try{d=JSON.parse(localStorage.getItem(K)||'null')}catch(e){}if(!d||!Array.isArray(d.transactions)||d.transactions.length===0){localStorage.setItem(K,JSON.stringify(window.MONEY_CLOUD_BACKUP));}localStorage.setItem(M,'1')})();
